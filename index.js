import{a as u,S as p,i as n}from"./assets/vendor-BNibzuFn.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const m="52952317-f5e88216fd9e8d5aa3001977e",f="https://pixabay.com/api/";async function g(s){const a={key:m,q:s,image_type:"photo",orientation:"horizontal",safesearch:!0};return(await u.get(f,{params:a})).data}const c=document.querySelector(".gallery"),d=document.querySelector("#loader"),y=new p(".gallery a",{captionsData:"alt",captionDelay:250});function h({webformatURL:s,largeImageURL:a,tags:r,likes:i,views:e,comments:t,downloads:o}){return`
